========================================================================
    KONSOLENANWENDUNG: Nearest-Neighbour-01-Projektübersicht
========================================================================

Diese Nearest-Neighbour-01-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre Nearest-Neighbour-01-Anwendung besteht.


Nearest-Neighbour-01.vcxproj
...
Nearest-Neighbour-01.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "Nearest-Neighbour-01.pch und eine 
